...
const handleLogout = () => {
  ...
  localStorage.removeItem("adminDashUsername");
  navigate("/admin/login");
};
    ...
    <div className="app-shell">
      ...
      <main className="app-main">
            ...
            <>
              <div className="filters-grid" style={{ marginBottom: 20 }}>
                <div className="stat-card">
                  ...
                  <strong className="stat-value stat-value--total">
                    {stats.totalVoters}
                  </strong>
                </div>
                <div className="stat-card">
                  <label>Done</label>
                  <strong className="stat-value stat-value--done">
                    {stats.overall.done}
                  </strong>
                </div>
                <div className="stat-card">
                  <label>Not Done</label>
                  <strong className="stat-value stat-value--not-done">
        ...
        <section className="card">
          ...
          {votersError && <p className="error-text">{votersError}</p>}
                    ...
                    sortedVoters.map((v) => (
                      <tr key={v._id} className={ROW_CLASS[v.status] || ""}>
                        ...
                        <td
                          ...
                          onClick={() =>
                            openExpanded("Voter Name", v.electorName)
                          }
                        >
                          {v.electorName}
                        </td>
